...
class Game {
  ...
  checkMilestone() {
    ...
    if (this.hitCount % 5 === 0 && this.hitCount > 0) {
      ...
      console.log(`🚀 Rally #${this.hitCount}! Speed increased!`);
    }
  }
...
Over these past couple of days I've learned a lot about game development, especially with simple 2D games like Pong. Here are some key takeaways:
- I learned how each part of the code plays into the next part, and how if anything is slightly off, the whole game can break.
- I also learned how to change colors and how to rotate them, thanks to Copilot, and how to make the ball leave a trail.
- Finally, I learned how to structure a game loop with input handling, updating game state, and rendering.
- Overall, building Pong was a great exercise in understanding the fundamentals of game development and programming and I look forward to applying these concepts to more complex games in the future!